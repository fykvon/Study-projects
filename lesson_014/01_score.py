...
game = argparse.ArgumentParser(description="This is points counter")
# game.add_argument('--name', help='Enter your name')
game.add_argument('--game_result', help='Enter your throwing sequence')
args = game.parse_args()


def main():
    point_count = bowling(game_result=args.game_result)
    # point_count = bowling(name=args.name, game_result=args.game_result)
    point_count.run()
