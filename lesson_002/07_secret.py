...
print(first_word, second_word, third_word, four_word, fifth_word)

# или в 1 строку, но мне такой вид кода не нравится. При проверке, когда придут ошибки,  удалю не верный вариант.
