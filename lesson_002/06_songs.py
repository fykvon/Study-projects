...
selected_song = violator_songs[3][1] + violator_songs[5][1] + violator_songs[8][1]
selected_song = round(selected_song, 2)

print('Три песни звучат ', selected_song, ' минут')
...
beyond_mirrors = pocket_universe_songs['Beyond Mirrors']
other_song = on_track + to_the_sea + beyond_mirrors
other_song = round(other_song)
print('А другие три песни звучат приблизительно ', other_song, ' минут')
