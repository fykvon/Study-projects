...
while True:
    ...
    user_color = 'blue' if player_number == 1 else 'yellow'
    cprint('Ход игрока {}'.format(player_number), color=user_color)
...
cprint('Выйграл игрок номер {}'.format(player_number), color='red')
